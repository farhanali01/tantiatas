			...
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6>About Us</h6>
						<p>
						Tantias Jakarta adalah konveksi tas yang berlokasi di Jalan PIK penggilingan Cakung Jakarta Timur konveksi tas ini mampu bersaing dengan bisnis konveksi tas lainnya di kawasan area tersebut melalui produk yang dijualnya adalah tas dengan harga terjangkau juga bermutu kualitasnya bagi seluruh pelanggan setianya.
						</p>
					</div>
				</div>
	...
	<script src="<?= base_url() ?>assets/home/js/tipe.js"></script>
