				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="<?= base_url() ?>Register">Daftar</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
                        ...
                        <?php }?> 
						<form action="<?= base_url()?>login/proses_login" class="row login_form" method="post" id="contactForm" novalidate="novalidate">
